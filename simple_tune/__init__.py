...
"""Main entry point for simple_tune.
...
Example:
    ...
    launch simple_tune by saying::

        $ simple_tune --ini=/path/to/config.ini [options ...]
...
def main(opts=None):
    ...
    if opts is None:
        ...
        opts = parse_opts(vcp_cmd='simple_tune',
                          vcp_name='simple_tune',
